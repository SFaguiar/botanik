...
<html lang="pt-br">
    ...
    <body>
        <form action="?act=save" method="POST" name="form1" >
          ...
          Nível:
          <br>
          <select id="nivel" name="nivel" <?php
          ...
          Alternativa Correta:
          <br>
          <textarea name="alternativa1" <?php if (isset($alternativa1) && $alternativa1 != null || $alternativa1 != ""){
            echo "value=\"{$alternativa1}\"";} ?> ></textarea>
          <br>
          Primeira alternativa incorreta:
          <br>
          <textarea name="alternativa2" <?php if (isset($alternativa2) && $alternativa2 != null || $alternativa2 != ""){
            echo "value=\"{$alternativa2}\"";} ?> ></textarea>
          <br>
          Segunda alternativa incorreta:
          <br>
          <textarea name="alternativa3" <?php if (isset($alternativa3) && $alternativa3 != null || $alternativa3 != ""){
            echo "value=\"{$alternativa3}\"";} ?> ></textarea>
          <br>
          Terceira alternativa incorreta:
          <br>
          <textarea name="alternativa4" <?php if (isset($alternativa4) && $alternativa4 != null || $alternativa4 != ""){
    echo "value=\"{$alternativa4}\"";} ?> ></textarea>
       ...
       <table border="1" width="100%">
        <tr>
            ...
            <th>Primeira alternativa incorreta</th>
            <th>Segunda alternativa incorreta</th>
            <th>Terceira alternativa incorreta</th>
          </tr>
       <?php
        try {
          ...
          if ($stmt->execute()) {
            while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
              ...
              echo "<td>".$rs->id."</td><td>".$rs->nivel."</td><td>".$rs->tipo."</td><td>".$rs->comando."</td><td>".$rs->imagem."</td><td>".$rs->alternativa1."</td><td>".$rs->alternativa2."</td><td>".$rs->alternativa3."</td><td>".$rs->alternativa4.
                "</td><td><center><a href=\botanik/novas_questoes.php?act=upd&id=" . $rs->id . ">[Alterar]</a>"
                ."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                ."<a href=\botanik/novas_questoes.php?act=del&id=" . $rs->id . ">[Excluir]</a></center></td>";
              echo "</tr>";
          }
        } else {
